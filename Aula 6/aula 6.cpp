...
void exibir ( double a, double b, double c, double delta )
{
 cout << fixed << setprecision(2) << "\nValor de ....A:" << setfill(' ') << setw(10) << a;
 cout << "\nValor de ....B:" << setfill(' ') << setw(10) << b;
 cout << "\nValor de ....C:" << setfill(' ') << setw(10) << c << endl;
 cout << "\nValor de Delta:" << setfill(' ') << setw(10) << delta << endl;
...
if ( delta >= 0 )
 { 
   ...
   cout << fixed << setprecision(2) << "\nValor de ....x1:" << setfill(' ') << setw(9) << x1;
   cout << "\nValor de ....x2:" << setfill(' ') << setw(9) << x2 << endl;
  }
else 
{ 
